...
const aiLogos = [
  ...
  },
  {
    ...
    position: [1, 1],
    isDark: true,
    accentColor: "rgba(110, 84, 148, 0.4)", // Morado de Microsoft
  },
  {
    name: "Mistral",
      ...
      >
        <motion.div
          ...
          style={{
            ...
            paddingTop: isMobile ? "0" : theme.spacing(4),
            overflow: "hidden",
          }}
        >
          <SlideTitle
            ...
            style={{
              ...
              marginBottom: isMobile ? "0" : "clamp(24px, 6vh, 42px)",
              textAlign: "center",
          ...
          {/* Bento Grid layout - solo se muestra si no es un dispositivo móvil */}
          {!isMobile && (
            <motion.div
              variants={contentVariants}
                  ...
                  >
                    ...
                    >
                      <p
                        style={{
                          fontSize:
                            logo.size === "medium" ? "1.2rem" : "0.9rem",
                          fontWeight: 500,
                          margin: 0,
